...
$data = file_get_contents("http://ddragon.leagueoflegends.com/cdn/12.23.1/data/it_IT/item.json");
...
foreach ($data as $item_id => $item) {
	...
	$stmt = $pdo->prepare("INSERT IGNORE INTO item VALUES(:item_id, :name, :image, :gold, :description, :stats, :version);");
	$stmt->execute([
		'item_id' => intval($item_id),
		'name' => strip_tags($item['name']),
		'image' => "http://ddragon.leagueoflegends.com/cdn/12.23.1/img/item/" . $item['image']['full'],
